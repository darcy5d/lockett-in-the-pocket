...
def main():
    """Example script showing how to use both the neural network model and EnhancedPredictor"""
    print("AFL Prediction Example (Enhanced)")
    print("================================")
    ...
    if model is None:
        print("Failed to load model directly. Try Method 2 with EnhancedPredictor.")
    else:
    ...
    # Method 2: Use EnhancedPredictor with custom paths
    print("\nMethod 2: Using EnhancedPredictor")
    print("-------------------------------")
    # Create a new EnhancedPredictor (instead of SimplePredictor)
    ...
    if predictor.load_model():
        print("EnhancedPredictor model loaded successfully!")
    else:
        print("Building model with EnhancedPredictor...")
        predictor.build_model()
    
    if predictor.model is not None:
        print("EnhancedPredictor ready!")
    ...
    print("2. EnhancedPredictor provides a higher-level API with richer features and better Lambda layer handling.")
