#!/usr/bin/env python3
"""
Fetch the 2026 QLD Cup (Hostplus Cup) fixture from League Unlimited.

Source: https://leagueunlimited.com/competition/show/QRL-Queensland-Cup/2026/draw/full
Output: matches_qld-cup_2026.csv (per competition_config)

Usage:
    python datafetch/fetch_2026_qld_cup_fixture.py
"""
...
from core.qld_cup_mappings import TeamMapper, VenueMapper

OUTPUT_PATH = _PROJECT_ROOT / "nrl_data" / "data" / "matches" / "matches_qld-cup_2026.csv"
LEAGUE_UNLIMITED_BASE = "https://leagueunlimited.com/competition/show/QRL-Queensland-Cup/2026/draw/full"
YEAR = 2026
...
def _parse_match_link(text: str, href: str) -> dict | None:
    """
    Parse 'Wynnum Manly Seagulls v Souths Logan Magpies Sat 7 Mar 3:00PM at BMD Kougari Oval, Manly West / Quandamooka'
    """
